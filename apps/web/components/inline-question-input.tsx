    ...
    <div className="space-y-2.5 px-4 pt-3">
      ...
      <div className="flex items-start justify-between gap-3">
        <div className="flex min-w-0 flex-1 flex-wrap items-baseline gap-x-2 gap-y-1">
          <span className="shrink-0 font-mono text-xs font-medium text-base-content/60">
            {state.currentIndex + 1}/{questions.length}
          </span>
          <span className="shrink-0 font-mono text-[10px] font-semibold uppercase tracking-[0.15em] text-base-content/70">
