...
export const FolderIcon = lucide(Folder, "text-base-content/60");
...
const LockIcon = lucide(Lock, "text-base-content/60");
...
const GenericFileIcon = lucide(File, "text-base-content/60");
