...
export function SkillRenderer({
  ...
  const expandedContent = rawArgs ? (
    <pre className="max-h-48 overflow-auto whitespace-pre-wrap rounded-md border border-base-300 bg-base-200/50 p-3 font-mono text-xs leading-relaxed text-base-content/60">
      {rawArgs}
    </pre>
  ) : undefined;
  ...
  return (
    <ToolLayout
      ...
      state={mergedState}
      nameClassName={mergedState.error ? "text-error" : undefined}
