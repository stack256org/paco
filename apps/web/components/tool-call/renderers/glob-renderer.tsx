...
export function GlobRenderer({
  ...
  const expandedContent = hasExpandedContent ? (
    <pre className="max-h-64 overflow-auto rounded-md border border-base-300 bg-base-200/50 p-3 font-mono text-xs leading-relaxed text-base-content/60">
    ...
    <ToolLayout
      ...
      summary={
        <>
          ...
          {summary && (
            <span className="ml-1.5 text-base-content/60">{summary}</span>
          )}
        </>
      }
