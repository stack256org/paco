...
import type { TaskPendingToolCall } from "@paco/claude-code";
import { formatTokens, toRelativePath } from "@paco/shared";
...
export function TaskRenderer({
  ...
  const approvalWarning =
    taskApprovalRequested && subagentType === "executor" ? (
      <div className="mt-2 pl-5 text-sm text-warning">
  ...
  return (
    <ToolLayout
      ...
      nameClassName={taskDenied ? "text-error" : undefined}
