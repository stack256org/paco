  ...
  return (
    <div className="group relative min-w-0 max-w-full p-1">
      <button
        ...
        onClick={onPreview}
        className={cn(
          "flex max-w-full items-center gap-2 rounded-lg border border-base-300/60 bg-base-200/60 px-3 py-2",
          "text-left font-mono text-sm leading-tight text-base-content",
          "transition-colors hover:border-base-content/20 hover:bg-base-200",
        )}
      >
      ...
      <button
        ...
        className="absolute -right-0.5 -top-0.5 flex h-5 w-5 items-center justify-center rounded-full bg-base-300 text-base-content/70 opacity-0 transition-opacity hover:bg-base-content/40 group-hover:opacity-100"
