 ...
 * them down: both sections load independently on purpose — the admin page is
 * a list of unrelated panels, and one slow read should not hold up the
 * others. A subscription keeps that independence — a section that nobody is
 * listening to just publishes into nothing.
 *
