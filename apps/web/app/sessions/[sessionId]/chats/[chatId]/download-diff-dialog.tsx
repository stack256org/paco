...
function CommandBlock({ commands }: { commands: string }) {
  ...
  return (
    <div className="group relative">
      <pre className="overflow-x-auto rounded-lg border bg-base-300 p-4 pr-12 font-mono text-xs leading-relaxed text-base-content">
        <code>{commands}</code>
      </pre>
      <button
        type="button"
        ...
        className={cn(
          "absolute right-2 top-2 inline-flex h-7 w-7 items-center justify-center rounded-md text-base-content/70",
          "transition-[color,background-color,transform] duration-150 ease-out",
          "hover:bg-base-300 hover:text-base-content active:scale-95",
