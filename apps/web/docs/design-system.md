...
This document defines the visual design system used across the Paco web application, particularly for unauthenticated/marketing pages.

## Design Philosophy

The design follows a **dark terminal aesthetic** that reflects the developer-focused, CLI-centric nature of Paco. The visual language communicates:
